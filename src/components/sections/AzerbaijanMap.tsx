...
const locations = [
  ...
  { id: "khinalug", name: { ru: "Хыналыг",  en: "Khinalug", az: "Xınalıq", tr: "Hınalıg"  }, desc: { ru: "Высокогорное древнее село",           en: "Ancient high mountain village",    az: "Dağ kəndi",               tr: "Dağ köyü"                   }, days: { ru: "от 2 дней", en: "from 2 days", az: "2 gündən", tr: "2 günden" }, img: "/images/khinalug village azerbaijan mountains.png",               lat: 41.1969, lng: 48.1428 },
