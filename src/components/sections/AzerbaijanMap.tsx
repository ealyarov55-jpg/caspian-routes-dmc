...
const locations = [
  ...
  { id: "shahdag",  name: { ru: "Шахдаг",    en: "Shahdag",  az: "Şahdağ",  tr: "Şahdağ"   }, desc: { ru: "Главный горный курорт страны",        en: "Top mountain resort",              az: "Ən böyük dağ kurort",     tr: "Başlıca dağ tatil köyü"    }, days: { ru: "от 3 дней", en: "from 3 days", az: "3 gündən", tr: "3 günden" }, img: "/images/Gabala mountains winter skiing.jpg",              lat: 41.2700, lng: 48.1600 },
