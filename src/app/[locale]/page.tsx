...
{ name: lang === "ru" ? "Баку" : "Baku", desc: lang === "ru" ? "Столица и сердце Азербайджана" : "Capital of Azerbaijan", days: lang === "ru" ? "от 2 дней" : "from 2 days", img: "/images/Baku city aerial view.jpeg" },
  { name: lang === "ru" ? "Баку" : lang === "az" ? "Bakı" : lang === "tr" ? "Bakü" : "Baku", desc: lang === "ru" ? "Столица и сердце Азербайджана" : lang === "az" ? "Azərbaycanın paytaxtı" : lang === "tr" ? "Azerbaycan'ın başkenti" : "Capital of Azerbaijan", days: lang === "ru" ? "от 2 дней" : lang === "az" ? "2 gündən" : lang === "tr" ? "2 günden" : "from 2 days", img: "/images/Baku city aerial view.jpeg" },
  { name: lang === "ru" ? "Габала" : lang === "az" ? "Qəbələ" : lang === "tr" ? "Gabala" : "Gabala", desc: lang === "ru" ? "Швейцария Азербайджана" : lang === "az" ? "Azərbaycanın İsveçrəsi" : lang === "tr" ? "Azerbaycan'ın İsviçresi" : "Switzerland of Azerbaijan", days: lang === "ru" ? "от 3 дней" : lang === "az" ? "3 gündən" : lang === "tr" ? "3 günden" : "from 3 days", img: "/images/gabala azerbaijan nature forest.jpg" },
  { name: lang === "ru" ? "Шеки" : lang === "az" ? "Şəki" : lang === "tr" ? "Şeki" : "Sheki", desc: lang === "ru" ? "Древний город Шёлкового пути" : lang === "az" ? "Qədim İpək Yolu şəhəri" : lang === "tr" ? "Antik İpek Yolu şehri" : "Ancient Silk Road city", days: lang === "ru" ? "от 2 дней" : lang === "az" ? "2 gündən" : lang === "tr" ? "2 günden" : "from 2 days", img: "/images/Sheki palace Azerbaijan.jpg" },
  { name: lang === "ru" ? "Гобустан" : lang === "az" ? "Qobustan" : lang === "tr" ? "Gobustan" : "Gobustan", desc: lang === "ru" ? "Петроглифы и грязевые вулканы" : lang === "az" ? "Qayaüstü rəsmlər" : lang === "tr" ? "Kaya resimleri" : "Petroglyphs and mud volcanoes", days: lang === "ru" ? "от 1 дня" : lang === "az" ? "1 gündən" : lang === "tr" ? "1 günden" : "from 1 day", img: "/images/gobustan mud volcanoes petroglyphs.jpg" },
  { name: lang === "ru" ? "Хыналыг" : lang === "az" ? "Xınalıq" : lang === "tr" ? "Hınalıg" : "Khinalug", desc: lang === "ru" ? "Высокогорное село" : lang === "az" ? "Dağ kəndi" : lang === "tr" ? "Dağ köyü" : "High mountain village", days: lang === "ru" ? "от 2 дней" : lang === "az" ? "2 gündən" : lang === "tr" ? "2 günden" : "from 2 days", img: "/images/khinalug village azerbaijan mountains.jpg" },
  { name: lang === "ru" ? "Лагич" : lang === "az" ? "Lahıc" : lang === "tr" ? "Lahıc" : "Lahij", desc: lang === "ru" ? "Деревня мастеров" : lang === "az" ? "Sənətkarlar kəndi" : lang === "tr" ? "Zanaatkârlar köyü" : "Village of craftsmen", days: lang === "ru" ? "от 2 дней" : lang === "az" ? "2 gündən" : lang === "tr" ? "2 günden" : "from 2 days", img: "/images/lahij village craftsmen azerbaijan copper.jpg" },
  { name: lang === "ru" ? "Шахдаг" : lang === "az" ? "Şahdağ" : lang === "tr" ? "Şahdağ" : "Shahdag", desc: lang === "ru" ? "Горный курорт" : lang === "az" ? "Dağ kurort" : lang === "tr" ? "Dağ tatil köyü" : "Mountain resort", days: lang === "ru" ? "от 3 дней" : lang === "az" ? "3 gündən" : lang === "tr" ? "3 günden" : "from 3 days", img: "/images/shahdag ski resort azerbaijan winter.jpg" },
  { name: lang === "ru" ? "Губа" : lang === "az" ? "Quba" : lang === "tr" ? "Kuba" : "Guba", desc: lang === "ru" ? "Яблочный край" : lang === "az" ? "Alma diyarı" : lang === "tr" ? "Elma diyarı" : "Apple region", days: lang === "ru" ? "от 2 дней" : lang === "az" ? "2 gündən" : lang === "tr" ? "2 günden" : "from 2 days", img: "/images/Quba.jpg" },
].map((dest, i) => (
