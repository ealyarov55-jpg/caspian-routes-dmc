...
<p style={{ color: T.textMuted, fontSize: 14, margin: 0 }}>
  {lang === "ru" ? "Выберите регион — и ИИ построит для вас готовый маршрут" : lang === "az" ? "Bölgəni seçin — AI marşrutunuzu quracaq" : lang === "tr" ? "Bölge seçin — AI rotanızı oluştursun" : "Choose a region and AI will build your itinerary"}
        ...
        <div className="dest-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16 }}>
          {[
{ name: lang === "ru" ? "Баку" : lang === "az" ? "Bakı" : lang === "tr" ? "Bakü" : "Baku", desc: lang === "ru" ? "Столица и сердце Азербайджана" : lang === "az" ? "Azərbaycanın paytaxtı" : lang === "tr" ? "Azerbaycan'ın başkenti" : "Capital of Azerbaijan", img: "/images/Baku city aerial view.jpeg", href: `/${locale}/blog/marshrut-baku-3-dnya` },
{ name: lang === "ru" ? "Габала" : lang === "az" ? "Qəbələ" : lang === "tr" ? "Gabala" : "Gabala", desc: lang === "ru" ? "Швейцария Азербайджана" : lang === "az" ? "Azərbaycanın İsveçrəsi" : lang === "tr" ? "Azerbaycan'ın İsviçresi" : "Switzerland of Azerbaijan", img: "/images/gabala azerbaijan nature forest.jpg", href: `/${locale}/blog/gabala-2026` },
{ name: lang === "ru" ? "Шеки" : lang === "az" ? "Şəki" : lang === "tr" ? "Şeki" : "Sheki", desc: lang === "ru" ? "Древний город Шёлкового пути" : lang === "az" ? "Qədim İpək Yolu şəhəri" : lang === "tr" ? "Antik İpek Yolu şehri" : "Ancient Silk Road city", img: "/images/Sheki palace Azerbaijan.jpg", href: `/${locale}/blog/sheki-za-1-den` },
{ name: lang === "ru" ? "Гобустан" : lang === "az" ? "Qobustan" : lang === "tr" ? "Gobustan" : "Gobustan", desc: lang === "ru" ? "Петроглифы и грязевые вулканы" : lang === "az" ? "Qayaüstü rəsmlər" : lang === "tr" ? "Kaya resimleri" : "Petroglyphs and mud volcanoes", img: "/images/gobustan mud volcanoes petroglyphs.jpg", href: `/${locale}/blog/gobustan-kak-dobratsa` },
{ name: lang === "ru" ? "Хыналыг" : lang === "az" ? "Xınalıq" : lang === "tr" ? "Hınalıg" : "Khinalug", desc: lang === "ru" ? "Высокогорное село" : lang === "az" ? "Dağ kəndi" : lang === "tr" ? "Dağ köyü" : "High mountain village", img: "/images/khinalug village azerbaijan mountains.jpg", href: `/${locale}/blog/khinalug-2026` },
{ name: lang === "ru" ? "Лагич" : lang === "az" ? "Lahıc" : lang === "tr" ? "Lahıc" : "Lahij", desc: lang === "ru" ? "Деревня мастеров" : lang === "az" ? "Sənətkarlar kəndi" : lang === "tr" ? "Zanaatkârlar köyü" : "Village of craftsmen", img: "/images/lahij village craftsmen azerbaijan copper.jpg", href: `/${locale}/blog/lahij-2026` },
{ name: lang === "ru" ? "Шахдаг" : lang === "az" ? "Şahdağ" : lang === "tr" ? "Şahdağ" : "Shahdag", desc: lang === "ru" ? "Горный курорт" : lang === "az" ? "Dağ kurort" : lang === "tr" ? "Dağ tatil köyü" : "Mountain resort", img: "/images/shahdag ski resort azerbaijan winter.jpg", href: `/${locale}/blog/shahdag-2026` },
{ name: lang === "ru" ? "Губа" : lang === "az" ? "Quba" : lang === "tr" ? "Kuba" : "Guba", desc: lang === "ru" ? "Яблочный край" : lang === "az" ? "Alma diyarı" : lang === "tr" ? "Elma diyarı" : "Apple region", img: "/images/Quba.jpg", href: `/${locale}/blog/guba-2026` },
].map((dest, i) => (
  <Link key={i} href={dest.href} className="dest-card" style={{ textDecoration: "none", borderRadius: 12, overflow: "hidden", position: "relative", display: "block", background: "#0a0f1a" }}>
