...
{ name: lang === "ru" ? "Габала" : lang === "az" ? "Qəbələ" : lang === "tr" ? "Gabala" : "Gabala", desc: lang === "ru" ? "Швейцария Азербайджана" : lang === "az" ? "Azərbaycanın İsveçrəsi" : lang === "tr" ? "Azerbaycan'ın İsviçresi" : "Switzerland of Azerbaijan", img: "/images/gabala azerbaijan nature forest.jpg", href: `/${locale}/blog/gabala-zimoy` },
...
{ name: lang === "ru" ? "Хыналыг" : lang === "az" ? "Xınalıq" : lang === "tr" ? "Hınalıg" : "Khinalug", desc: lang === "ru" ? "Высокогорное село" : lang === "az" ? "Dağ kəndi" : lang === "tr" ? "Dağ köyü" : "High mountain village", img: "/images/khinalug village azerbaijan mountains.jpg", href: `/${locale}/planner` },
{ name: lang === "ru" ? "Лагич" : lang === "az" ? "Lahıc" : lang === "tr" ? "Lahıc" : "Lahij", desc: lang === "ru" ? "Деревня мастеров" : lang === "az" ? "Sənətkarlar kəndi" : lang === "tr" ? "Zanaatkârlar köyü" : "Village of craftsmen", img: "/images/lahij village craftsmen azerbaijan copper.jpg", href: `/${locale}/planner` },
{ name: lang === "ru" ? "Шахдаг" : lang === "az" ? "Şahdağ" : lang === "tr" ? "Şahdağ" : "Shahdag", desc: lang === "ru" ? "Горный курорт" : lang === "az" ? "Dağ kurort" : lang === "tr" ? "Dağ tatil köyü" : "Mountain resort", img: "/images/shahdag ski resort azerbaijan winter.jpg", href: `/${locale}/planner` },
{ name: lang === "ru" ? "Губа" : lang === "az" ? "Quba" : lang === "tr" ? "Kuba" : "Guba", desc: lang === "ru" ? "Яблочный край" : lang === "az" ? "Alma diyarı" : lang === "tr" ? "Elma diyarı" : "Apple region", img: "/images/Quba.jpg", href: `/${locale}/planner` },
].map((dest, i) => (
